...
<span class="rally-title">RALLY AI Consumer Profiling Optimizer</span>
</div>
""", unsafe_allow_html=True)
...
st.markdown('<div class="section-header">Consumer Profiling Tool</div>', unsafe_allow_html=True)
...
consumer_content = st.text_area("📄 Consumer Responses", height=200)
user_prompt = st.text_area("🧠 Prompt for Consumer Profiling (include your JSON instructions)", height=150)
...
if run and consumer_content and user_prompt:
